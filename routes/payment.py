        ...
        try:
            ...
            if payload.delivery_info:
                ...
                delivery_response = await client.post(
                    "https://ordering-service.onrender.com/delivery/info",
            ...
            for item in payload.cart_items:
                ...
                cart_response = await client.post(
                    "https://ordering-service.onrender.com/cart/",
                    json=cart_payload,
                    headers={"Authorization": f"Bearer {token}"}
                )
            ...
            finalize_response = await client.post(
                f"https://ordering-service.onrender.com/cart/finalize?username={payload.username}",
                headers={"Authorization": f"Bearer {token}"}
            )
            ...
            update_order_response = await client.put(
                "https://ordering-service.onrender.com/cart/update-payment",
